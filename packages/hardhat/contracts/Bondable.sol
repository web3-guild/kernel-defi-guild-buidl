...
contract Bondable {
    ...
    function createMarket(
        ...
        require(
            markets[underlying][maturity].maximumDebt == 0,
            "Market already exists"
        );
        // create the bond token
        address bondAddress = address(
            new zcToken(name, symbol, decimals, maturity, underlying)
        );
        // create the market
    ...
    function redeem(
        ...
        require(
            ...
            "bond maturity has not been reached"
        );
        ...
        require(
            newRedeemedDebt <= _market.repaidDebt,
            "total market claim exceeds debt repaid"
        );
        // burn the bond
    ...
    function repay(
        ...
        require(
            newRepaidDebt <= _market.mintedDebt,
            "can not repay more debt than is minted"
        );
